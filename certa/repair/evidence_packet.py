...
class CERACommitResult:
    ...
    def to_prediction_fields(
        ...
        *,
        ...
        for key in (
            "certa_egra_arm",
            "certa_egra_role_contract_called",
            "certa_egra_role_contract_valid",
            "certa_egra_role_contract_parse_ok",
            "certa_egra_role_contract_errors",
            "certa_egra_role_contract",
            "certa_egra_role_contract_audit",
            "certa_egra_construction_error",
            "certa_egra_table_sha256",
            "certa_egra_catalog_sha256",
            "certa_egra_card_count",
            "certa_egra_active_card_count",
            "certa_egra_structural_cards",
            "certa_egra_index_cache_key",
            "certa_egra_index_sha256",
            "certa_egra_retrieval",
            "certa_egra_catalog_seconds",
            "certa_egra_index_seconds",
            "certa_egra_retrieval_seconds",
            "certa_egra_index_cache_hit",
            "cera_round9_partition_original_count",
            "cera_round9_partition_alternative_count",
            "cera_round9_partition_disjoint",
            "cera_round9_partition_exhaustive",
            "cera_round9_partition_equivalence_policy",
